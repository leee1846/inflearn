...
### 7. 느낀점
    README를 읽고 과제가 vanilla javascript라는걸 보자마자 그동안 얼마나 리액트에 의존해왔는지 깨달았고, 과제를 진행하면서 많은 자극을 받았습니다.
    파일구조는 어떻게 해야하는지, 페이지이동이 있는데 페이지는 어떻게 나누어야하는지, 컴포넌트단위로 간결하게
    ...
    구글링에 의존하면서 과제를 마무리 하긴했지만, 결과를 떠나서 다시한번 학습에 대한 의지가 생기게되는 기회였고 나름대로 성취감도
    느낄수있던 과제였습니다.
